  ...
  try {
    ...
    const credentialData = {
      ...
      styles: {
        ...
        thumbnail: { uri: 'https://example.com/mock_thumb.png', alt: 'Mock Thumb' }, // Mock thumbnail
      ...
      issuer: {
        ...
        styles: { // Mock issuer styles
          thumbnail: { uri: 'https://example.com/mock_issuer_thumb.png', alt: 'Mock Issuer Thumb' },
          hero: { uri: 'https://example.com/mock_issuer_hero.png', alt: 'Mock Issuer Hero' },
